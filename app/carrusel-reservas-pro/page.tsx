...
const slides: DeckSlide[] = [
  { accent: '#22d3ee', render: () => (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 40px 40px' }}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <h2 style={{ fontSize: 38, fontWeight: 900, margin: 0, lineHeight: 1.03, letterSpacing: '-0.02em' }}>Que reserven<br />solos,<br />mientras vos<br /><span style={{ background: 'linear-gradient(90deg,#67e8f9,#eda45f)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>trabajás</span></h2>
  ...
  { accent: '#eda45f', render: () => <Step n="3" kicker="24/7" color="#eda45f" title={<>Reservan a <span style={{ color: '#eda45f' }}>cualquier hora</span></>} text="A la madrugada, un domingo, cuando sea. El turno cae solo en tu agenda, al instante." /> },
  { accent: '#eda45f', render: () => <Step n="4" kicker="VOS TRANQUILA" color="#eda45f" title={<>Sin contestar <span style={{ color: '#eda45f' }}>nada</span></>} text="Menos mensajes, menos idas y vueltas. Tu agenda se llena sola mientras hacés lo tuyo." /> },
