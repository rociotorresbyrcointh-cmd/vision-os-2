...
const slides: DeckSlide[] = [
  ...
  { accent: '#34d399', render: () => (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 40px 40px' }}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <h2 style={{ fontSize: 37, fontWeight: 900, margin: 0, lineHeight: 1.03, letterSpacing: '-0.02em' }}>Dejá de<br />perder plata<br />con los que<br /><span style={{ background: 'linear-gradient(90deg,#6ee7b7,#eda45f)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>no vienen</span></h2>
        <div style={{ marginTop: 26, display: 'inline-flex', alignItems: 'center', gap: 9, background: 'white', color: '#0b0f17', borderRadius: 999, padding: '11px 20px', fontSize: 14, fontWeight: 800 }}>Te muestro cómo <ArrowRight size={16} /></div>
      </div>
    </div>
  ) },
  ...
  { accent: '#eda45f', render: () => <Step n="2" kicker="LA SOLUCIÓN" color="#eda45f" title={<>Cobrás una <span style={{ color: '#eda45f' }}>seña</span></>} text="Al reservar, tu cliente deja una seña por adelantado. Simple y automático, desde el link." /> },
  ...
  { accent: '#eda45f', render: () => <Step n="4" kicker="Y SI FALTA" color="#eda45f" title={<>No perdés <span style={{ color: '#eda45f' }}>nada</span></>} text="Si igual no viene, la seña ya quedó cobrada. Tu tiempo siempre está cubierto." /> },
