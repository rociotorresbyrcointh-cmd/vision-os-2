...
const slides: DeckSlide[] = [
  { accent: '#e5883e', render: () => (
    <div style={{ textAlign: 'center', padding: '0 40px' }}>
      <div style={{ display: 'inline-block', fontFamily: "'Orbitron', sans-serif", fontSize: 12, fontWeight: 800, letterSpacing: '0.24em', color: '#eda45f', border: '1px solid rgba(229,136,62,0.4)', borderRadius: 999, padding: '7px 16px', marginBottom: 22 }}>GUÍA RÁPIDA</div>
      <h2 style={{ fontSize: 40, fontWeight: 900, margin: 0, lineHeight: 1.05 }}>Turnos <span style={{ color: '#eda45f' }}>sin caos</span></h2>
  ...
  { accent: '#eda45f', render: () => <Step n="01" icon={CalendarPlus} color="#eda45f" title="Cargá un turno en segundos" text="Elegís cliente, servicio y profesional. La duración se calcula sola y queda ordenado." /> },
  { accent: '#e5883e', render: () => <Step n="02" icon={Repeat} color="#eda45f" title="Programá turnos que se repiten" text="“Todos los martes a las 15” y la app crea la serie sola, saltando feriados y bloqueos." /> },
  ...
  { accent: '#e5883e', render: () => (
    <div style={{ textAlign: 'center', padding: '0 40px' }}>
      <h2 style={{ fontSize: 34, fontWeight: 900, margin: 0, lineHeight: 1.1 }}>Empezá <span style={{ color: '#eda45f' }}>hoy</span></h2>
