...
const slides: DeckSlide[] = [
  { accent: '#e5883e', render: () => (
    <div style={{ textAlign: 'center', padding: '0 40px' }}>
      <div style={{ display: 'inline-block', fontFamily: "'Orbitron', sans-serif", fontSize: 12, fontWeight: 800, letterSpacing: '0.24em', color: '#eda45f', border: '1px solid rgba(229,136,62,0.4)', borderRadius: 999, padding: '7px 16px', marginBottom: 22 }}>INTELIGENCIA ARTIFICIAL</div>
      <h2 style={{ fontSize: 38, fontWeight: 900, margin: 0, lineHeight: 1.05 }}>Contenido para tus redes <span style={{ color: '#eda45f' }}>con IA</span></h2>
  ...
  { accent: '#eda45f', render: () => <Step n="01" icon={Sparkles} color="#eda45f" title="Elegí qué querés mostrar" text="Un servicio, una promo o una novedad. Le decís a la app de qué se trata y listo." /> },
  { accent: '#eda45f', render: () => <Step n="02" icon={Wand2} color="#eda45f" title="La IA crea la imagen" text="Genera una foto lista para postear, pensada para tu rubro y con tu estilo." /> },
  ...
  { accent: '#e5883e', render: () => (
    <div style={{ textAlign: 'center', padding: '0 40px' }}>
      <h2 style={{ fontSize: 34, fontWeight: 900, margin: 0, lineHeight: 1.1 }}>Probá la <span style={{ color: '#eda45f' }}>IA</span> gratis</h2>
