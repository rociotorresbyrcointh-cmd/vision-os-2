...
const slides: DeckSlide[] = [
  ...
  { accent: '#e5883e', render: () => (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 40px 40px' }}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <div style={{ fontFamily: "'Orbitron', sans-serif", fontSize: 11, fontWeight: 800, letterSpacing: '0.24em', color: '#eda45f', marginBottom: 14 }}>INTELIGENCIA ARTIFICIAL</div>
        <h2 style={{ fontSize: 38, fontWeight: 900, margin: 0, lineHeight: 1.03, letterSpacing: '-0.02em' }}>Creá el<br />contenido de<br />tus redes<br /><span style={{ background: 'linear-gradient(90deg,#eda45f,#eda45f)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>en minutos</span></h2>
  ...
  { accent: '#eda45f', render: () => <Step n="1" kicker="ELEGÍS" color="#eda45f" title={<>Decís qué querés <span style={{ color: '#eda45f' }}>mostrar</span></>} text="Una promo, un servicio, una novedad. Lo escribís en una línea, como se lo dirías a alguien." /> },
  { accent: '#eda45f', render: () => <Step n="2" kicker="LA IA TRABAJA" color="#eda45f" title={<>Crea la imagen <span style={{ color: '#eda45f' }}>por vos</span></>} text="En segundos genera una imagen pensada para tu rubro, sin que sepas nada de diseño." /> },
  ...
  { accent: '#e5883e', render: () => (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center', alignItems: 'center', padding: '0 36px 40px' }}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <h2 style={{ fontSize: 30, fontWeight: 900, margin: 0, lineHeight: 1.08, letterSpacing: '-0.01em' }}>Tus redes activas,<br />sin perder <span style={{ color: '#eda45f' }}>horas</span></h2>
