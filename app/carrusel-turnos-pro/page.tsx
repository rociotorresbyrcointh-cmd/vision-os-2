...
const slides: DeckSlide[] = [
  ...
  { accent: '#e5883e', render: () => (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 40px 40px' }}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <h2 style={{ fontSize: 38, fontWeight: 900, margin: 0, lineHeight: 1.03, letterSpacing: '-0.02em' }}>Manejá tu<br />agenda como<br />un <span style={{ background: 'linear-gradient(90deg,#eda45f,#22d3ee)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>profesional</span></h2>
  ...
  { accent: '#eda45f', render: () => <Step n="1" kicker="AGENDA" color="#eda45f" title={<>Todo en <span style={{ color: '#eda45f' }}>orden</span></>} text="Cargás un turno en segundos y nunca más te superponés. Chau cuaderno y Google Calendar." /> },
  ...
  { accent: '#eda45f', render: () => <Step n="4" kicker="TUS NÚMEROS" color="#eda45f" title={<>Sabés cuánto <span style={{ color: '#eda45f' }}>facturás</span></>} text="Caja y reportes claros: cuánto entró, qué servicio deja más y quién falta seguido." /> },
  ...
  { accent: '#e5883e', render: () => (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center', alignItems: 'center', padding: '0 36px 40px' }}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <h2 style={{ fontSize: 30, fontWeight: 900, margin: 0, lineHeight: 1.08, letterSpacing: '-0.01em' }}>Ordená tu negocio<br />desde <span style={{ color: '#eda45f' }}>hoy</span></h2>
